...
const Trash = () => {
  ...
  const { tasks, restoreTaskAsync, deleteTaskAsync } = useTaskStore();
      ...
      <MuiList sx={{ pt: 1 }}>
        {sidebarItems.map((item) => (
          <ListItem key={item.key} disablePadding>
            ...
            >
              <ListItemIcon sx={{ color: item.key === 'Trash' ? theme.palette.primary.contrastText : 'inherit' }}>
                {item.icon}
              </ListItemIcon>
